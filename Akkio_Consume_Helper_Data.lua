...
Akkio_Consume_Helper_Data.allBuffs = {
  ...
  { name = "Juju Guile",                 icon = "Interface\\Icons\\INV_Misc_MonsterScales_13",  buffIcon = "Interface\\Icons\\INV_Misc_MonsterScales_13",                                                                                canBeAnounced = false, duration = 1800, itemID = 12458 },
